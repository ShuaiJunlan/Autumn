...
if(item.state=="open"){
$("<span class=\"tree-icon tree-folder tree-folder-open layui-icon larry-icon \"></span>").addClass(item.iconCls).prependTo(node);
...
$("<span class=\"tree-icon tree-file layui-icon larry-icon layui-icon larry-icon" +
...
if(_146.hasClass("tree-file layui-icon larry-icon")){
_146.removeClass("tree-file layui-icon larry-icon").addClass("layui-icon larry-icon ");
...
var node=ul.prev();
node.find(".tree-icon").removeClass("tree-folder").addClass("tree-file layui-icon larry-icon");
...
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open tree-file layui-icon larry-icon");
...
if(_72f.hasClass("tree-file layui-icon larry-icon")){
_72f.removeClass("tree-file layui-icon larry-icon").addClass("tree-folder tree-folder-open tree-file layui-icon larry-icon");
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("tree-folder").addClass("tree-file layui-icon larry-icon");
...
cc.push("<span class=\"tree-icon tree-folder tree-file layui-icon larry-icon "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon tree-folder tree-folder-open tree-file layui-icon larry-icon "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon tree-file layui-icon larry-icon "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
